  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen gap-4">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2 min-w-[300px]">
        ...
        <input type="email" name="email" placeholder="example@inflearn.com" value={email}
        ...
        <input type="password" name="passwordConfirm" placeholder="********" value={passwordConfirm} onChange={(e) => setPasswordConfirm(e.target.value)}
          className="border-2 border-gray-400 rounded-sm p-2"
        />
        <button type="submit"
